-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'ALUMNI', 'MENTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('DISCUSSION', 'QUESTION', 'ANNOUNCEMENT', 'RESOURCE');

-- CreateEnum
CREATE TYPE "ReactionType" AS ENUM ('LIKE', 'UPVOTE');

-- CreateEnum
CREATE TYPE "MediaType" AS ENUM ('IMAGE', 'VIDEO', 'PDF', 'DOCUMENT');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COMMENT', 'REPLY', 'FOLLOW', 'POST_REACTION', 'COMMENT_REACTION');
...
-- CreateIndex
CREATE INDEX "Notification_targetUserId_createdAt_idx" ON "Notification"("targetUserId", "createdAt" DESC);
